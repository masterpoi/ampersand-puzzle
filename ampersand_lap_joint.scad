...
PIECE_POLYS = [
    ...
    /* 2 top-ctr-R    */ [[ 95,  0],[158,  0],[155, 70],[108, 58]],
    /* 3 top-right    */ [[158,  0],[200,  0],[200, 62],[155, 70]],
    /* 4 mid-left     */ [[  0,115],[ 42,115],[ 55,138],[  0,125]],
    /* 5 mid-ctr-L    */ [[ 42, 72],[ 42,115],[ 55,138],[ 92,122],[108, 58]],
    /* 6 mid-ctr-R    */ [[108, 58],[155, 70],[148,135],[ 92,122]],
    /* 7 mid-right    */ [[155, 70],[200, 62],[200,138],[148,135]],
    /* 8 bot-left     */ [[  0,125],[ 55,138],[ 48,200],[  0,200]],
    /* 9 bot-ctr-L    */ [[ 55,138],[ 92,122],[105,200],[ 48,200]],
    /* 10 bot-ctr-R   */ [[ 92,122],[148,135],[145,200],[105,200]],
    /* 11 bot-right   */ [[148,135],[200,138],[200,200],[145,200]],
];
...
TAB_JOINTS = [
    ...
    [  6,  7, 151.5, 102.5,  0.994,  0.107, 10 ],  //  8  P6 → P7
    [  5,  9,  71.5, 130.0,  0.396,  0.918, 10 ],  //  9  P5 → P9
    [  6, 10, 120.0, 128.5, -0.226,  0.974, 10 ],  // 10  P6 → P10
    [  7, 11, 174.0, 136.5, -0.058,  0.998, 10 ],  // 11  P7 → P11
    [  8,  9,  51.5, 169.0,  0.994,  0.112, 10 ],  // 12  P8 → P9
    [  9, 10,  98.5, 161.0,  0.986, -0.164, 10 ],  // 13  P9 → P10
    [ 10, 11, 146.5, 167.5,  0.999,  0.046, 10 ],  // 14  P10 → P11
